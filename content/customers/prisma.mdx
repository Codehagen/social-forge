...
2. **Easy to create new links**: Dub provides a simple UI to create new links, along with useful features such as [tags](/help/article/organize-with-labels) to help organize links.
