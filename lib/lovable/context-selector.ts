import { FileManifest, EditIntent, EditType } from '@/types/lovable/file-manifest';
import { analyzeEditIntent } from '@/lib/lovable/edit-intent-analyzer';
import { getEditExamplesPrompt, getComponentPatternPrompt } from '@/lib/lovable/edit-examples';
