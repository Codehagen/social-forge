...
EOF`
    ...
    if (result.output && result.output.trim() && !agentMessageIdToUse) {
    ...
    if (hasChanges) {
      return {
        ...
        agentResponse: agentMessageIdToUse ? undefined : result.output || 'GitHub Copilot CLI completed the task',
        cliName: 'copilot',
      ...
      return {
        ...
        agentResponse: agentMessageIdToUse ? undefined : result.output,
        cliName: 'copilot',
        changesDetected: false,
        sessionId: extractedSessionId,
      }
