...
const Cursor = (props: SVGProps<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      ...
      <defs>
        <linearGradient gradientUnits="userSpaceOnUse" id={`cursor-fill-0-${uniqueId}`} x1={11.925} x2={11.925} y1={12} y2={24}>
        ...
        <linearGradient gradientUnits="userSpaceOnUse" id={`cursor-fill-2-${uniqueId}`} x1={11.925} x2={1.5} y1={0} y2={18}>
