        ...
        <div className="grid md:grid-cols-3 gap-8 px-4 md:px-0 md:pt-0 h-[580px] md:h-auto overflow-auto pb-[100px] md:pb-0">
          <div className="space-y-8">
            <Card>
              ...
              <h2 className="text-2xl">One Platform</h2>

              <p className="text-[#878787] text-sm text-center">
                Social Forge is an all-in-one platform for web agencies. Build websites with AI, manage clients in workspaces, track projects, and deliver professional results—all in one place.
              </p>
            </Card>
            ...
            <Card>
              ...
              <h2 className="text-2xl">Multi-Tenant</h2>

              <p className="text-[#878787] text-sm text-center">
                Workspaces allow agencies to manage multiple clients separately. Each client gets their own space with sites, team members, and settings—keeping everything organized and professional.
              </p>
            </Card>
          </div>
          <div className="space-y-8">
            <div className="px-8">
              <h2 className="text-[42px] text-center leading-[58px]">
                We empower agencies to build and sell websites faster with AI-powered automation and workspace management.
              </h2>
            </div>
            ...
            <Card>
              ...
              <h2 className="text-2xl">AI-Powered</h2>

              <p className="text-[#878787] text-sm text-center">
                Our AI builder generates professional websites from simple prompts. No coding required. We handle the technical complexity so agencies can focus on clients and creativity.
              </p>
            </Card>
          </div>

          <div className="ml-auto w-full space-y-8 flex items-center">
            <div className="border border-border p-6 bg-[#0C0C0C] w-full">
              <h2 className="text-xl mb-4">Key Features</h2>
              <ul className="space-y-3 text-[#878787] text-sm">
