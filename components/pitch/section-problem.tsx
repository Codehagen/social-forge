        ...
        <div className="grid md:grid-cols-3 gap-8 px-4 md:px-0 md:pt-0 h-[580px] md:h-auto overflow-auto pb-[100px] md:pb-0">
          <div className="space-y-8">
            <Card>
              ...
              <h2 className="text-2xl">Slow & Manual</h2>

              <p className="text-[#878787] text-sm text-center">
                Building websites for clients is time-consuming and manual. Agencies and freelancers spend hours on repetitive tasks instead of focusing on client relationships and business growth.
              </p>
            </Card>
            <div className="px-8">
              <h2 className="text-6xl text-center leading-tight">
                The current market for website creation is inefficient and expensive.
              </h2>
            </div>
          </div>
          <div className="space-y-8">
            <Card className="min-h-[315px]">
              ...
              <h2 className="text-2xl">Scattered Tools</h2>

              <p className="text-[#878787] text-sm text-center">
                Web agencies juggle multiple tools: builders, hosting, client management, billing, and communication platforms. This fragmented workflow wastes time and money.
              </p>
            </Card>
            <Card className="min-h-[315px]">
              <svg
              ...
              <h2 className="text-2xl">Technical Barriers</h2>

              <p className="text-[#878787] text-sm text-center">
                Creating professional websites requires technical expertise that many small businesses can't afford. This limits market access for agencies and frustrates potential clients.
              </p>
            </Card>
          </div>
          <div className="ml-auto w-full space-y-8 flex items-center">
            <div className="px-8">
              <h2 className="text-5xl text-center leading-tight">
                Agencies need a unified platform that automates website creation and manages the entire client lifecycle.
              </h2>
            </div>
          </div>
        </div>
