...
export function TaskForm({
      ...
      try {
        ...
        if (cachedRepos) {
          try {
            ...
            const reposList = Array.isArray(parsedRepos) ? parsedRepos : (parsedRepos.repos || [])
            setRepos(reposList)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const repoUrl = selectedRepoData?.clone_url || '';
  ...
  return (
    <div className="w-full max-w-2xl">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold mb-4">Social Forge Builder</h1>
        <p className="text-lg text-muted-foreground mb-2">
          AI-powered website builder powered by{' '}
          <a
