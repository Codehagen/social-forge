...
import AnimatedWidth from "@/components/lovable/shared/layout/animated-width";
import ArrowRight from "@/components/lovable/app/(home)/sections/hero-input/_svg/ArrowRight";
import Button from "@/components/lovable/shared/button/Button";
