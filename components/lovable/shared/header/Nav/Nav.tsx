import EndpointsCrawl from "@/components/lovable/app/(home)/sections/endpoints/EndpointsCrawl/EndpointsCrawl";
import EndpointsScrape from "@/components/lovable/app/(home)/sections/endpoints/EndpointsScrape/EndpointsScrape";
import EndpointsSearch from "@/components/lovable/app/(home)/sections/endpoints/EndpointsSearch/EndpointsSearch";
import EndpointsExtract from "@/components/lovable/app/(home)/sections/endpoints/Extract/Extract";
import EndpointsMcp from "@/components/lovable/app/(home)/sections/endpoints/Mcp/Mcp";
import { RenderEndpointIcon } from "@/components/lovable/shared/header/Nav/RenderEndpointIcon";
import HeaderDropdownContent from "@/components/lovable/shared/header/Dropdown/Content/Content";
import HeaderDropdownGithub from "@/components/lovable/shared/header/Dropdown/Github/Github";
import HeaderDropdownStories from "@/components/lovable/shared/header/Dropdown/Stories/Stories";
...
import Image from "@/components/lovable/shared/image/Image";
import GithubFlame from "@/components/lovable/shared/header/Dropdown/Github/Flame/Flame";
import EndpointsMap from "@/components/lovable/app/(home)/sections/endpoints/EndpointsMap/EndpointsMap";
