...
import Button from "@/components/lovable/ui/shadcn/button";
import {
  ConnectorToBottom,
  ConnectorToLeft,
  ConnectorToRight,
} from "@/components/lovable/shared/layout/curvy-rect";
import HeaderGithubClient from "@/components/lovable/shared/header/Github/GithubClient";
import { NAV_ITEMS } from "@/components/lovable/shared/header/Nav/Nav";
